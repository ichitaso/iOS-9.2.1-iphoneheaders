...
@property (assign,nonatomic) SCD_Struct_SX11 mapRect;                                        //@synthesize mapRect=_mapRect - In the implementation block
...
-(void)setupToolbar;
-(void)setMapRect:(SCD_Struct_SX11)arg1 ;
-(UIBarButtonItem *)doneBarButtonItem;
-(void)memoryWarning:(id)arg1 ;
-(SCD_Struct_SX11)mapRect;
