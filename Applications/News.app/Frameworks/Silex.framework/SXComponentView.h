...
@class SXComponent, SXComponentLayout, SXContext, SXFillView, SXColumnLayout, SXLayoutController, SXComponentStyleRenderer, SXComponentStyle;

@interface SXComponentView : UIView <SXTextCanvasRenderSource> {
