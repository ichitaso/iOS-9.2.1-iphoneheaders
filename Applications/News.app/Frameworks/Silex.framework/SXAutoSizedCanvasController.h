...
@interface SXAutoSizedCanvasController : NSObject <TSWPEditingControllerDelegate, TSWPInteractiveCanvasControllerDelegate> {
...
@property (nonatomic,readonly) double lineHeightOfFirstLine;                                            //@synthesize lineHeightOfFirstLine=_lineHeightOfFirstLine - In the implementation block
