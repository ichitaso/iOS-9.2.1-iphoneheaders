...
-(id)initWithViewportSize:(CGSize)arg1 layoutWidth:(long long)arg2 numberOfLayoutColumns:(unsigned long long)arg3 leftMargin:(double)arg4 rightMargin:(double)arg5 gutter:(double)arg6 numberOfColumns:(unsigned long long)arg7 andColumnWidth:(double)arg8 contentSizeCategory:(id)arg9 ;
