...
@class NSArray, NSMutableArray, SXItemizedScrollView, UIView, SXFullScreenCanvasController, SXMediaExposureEvent, SXMediaViewEvent, NSString;

@interface SXStripGalleryComponentView : SXGalleryComponentView <SXFullScreenCanvasShowable, SXItemizedScrollViewDataSource, SXItemizedScrollViewDelegate, SXImageViewDelegate> {
