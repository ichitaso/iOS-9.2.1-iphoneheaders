...
@class _UICascadingTextStorage, UIImage, UIView, UITextInputTraits, UIButton, UITextFieldBorderView, UITextFieldBackgroundView, _UIFloatingContentView, UIVisualEffectView, _UIDetachedFieldEditorBackgroundView, UITextFieldLabel, UIImageView, UILabel, UITextInteractionAssistant, UITapGestureRecognizer, UISystemInputViewController, UITextFieldAtomBackgroundView, NSLayoutConstraint, _UIBaselineLayoutStrut, NSString, UIFont, NSAttributedString, MPUTextContainerContentSizeUpdater, NSDictionary, UIColor, UITextRange, UITextPosition;
