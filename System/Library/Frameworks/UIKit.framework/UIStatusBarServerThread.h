...
@interface UIStatusBarServerThread : NSThread {
	...
	SCD_Struct_UI75 _statusBarData;
	SCD_Struct_UI75 _composedStatusBarData;
	SCD_Struct_UI76 _overrides;
...
-(SCD_Struct_UI76*)_statusBarOverrideData;
-(void)_postStatusBarData:(SCD_Struct_UI75*)arg1 actions:(int)arg2 ;
...
-(void)_postStatusBarOverrideData:(SCD_Struct_UI76*)arg1 ;
