...
@class _UIFocusEnginePanGestureRecognizer, UITapGestureRecognizer, _UIFocusPressGestureRecognizer, CADisplayLink, NSArray, NSMapTable, UIScrollView, NSObject, _UIFocusSoundPool, _UIFocusTouchDebugView, UIWindow, UIView, UIMoveEvent, NSString;
