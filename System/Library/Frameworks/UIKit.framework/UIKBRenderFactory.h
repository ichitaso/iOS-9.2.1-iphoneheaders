...
+(BOOL)_enabled;
+(id)lightweightFactoryForVisualStyle:(SCD_Struct_UI39)arg1 renderConfig:(id)arg2 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI39)arg1 renderConfig:(id)arg2 skipLayoutSegments:(BOOL)arg3 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI39)arg1 renderConfig:(id)arg2 ;
