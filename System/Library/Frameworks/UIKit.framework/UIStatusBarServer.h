...
+(void)postStatusBarData:(const SCD_Struct_UI75*)arg1 withActions:(int)arg2 ;
+(void)postStatusBarOverrideData:(SCD_Struct_UI76*)arg1 ;
+(void)permanentizeStatusBarOverrideData;
+(const SCD_Struct_UI75*)getStatusBarData;
+(SCD_Struct_UI76*)getStatusBarOverrideData;
...
-(void)_receivedStatusBarData:(SCD_Struct_UI75*)arg1 actions:(int)arg2 ;
