...
-(unsigned long long)directionsTypeForOriginCoordinate:(SCD_Struct_MK1)arg1 destinationCoordinate:(SCD_Struct_MK1)arg2 preferredDirectionsType:(unsigned long long)arg3 ;
...
-(SCD_Struct_MK1)destinationCoordinate;
@end
