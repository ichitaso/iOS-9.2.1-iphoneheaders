...
@interface NSString : NSObject <ASParsingLeafNode, CKDParsedObject, CNKeyDescriptor_Private, CSCoderEncoder, CKShortDescription, CKRecordValue, NSCopying, NSMutableCopying, NSSecureCoding>
