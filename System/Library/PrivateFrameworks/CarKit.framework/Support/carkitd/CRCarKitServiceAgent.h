...
@class CRCarKitMonitoringServiceAgent, CRVehicleAccessoryManager, CRVehicleStore, CRCarPlayPreferences, CRBulletinDataProvider, CRBluetoothManager, CRWiFiCarManager, NSMutableArray, NSNumber, NSString;
