...
@property (nonatomic,retain) NSMutableSet * contextsToObserve;                             //@synthesize contextsToObserve=_contextsToObserve - In the implementation block
...
-(void)setContextsToObserve:(NSMutableSet *)arg1 ;
-(void)setReindexing:(BOOL)arg1 ;
-(id)searchableItemForObject:(id)arg1 ;
-(NSMutableSet *)contextsToObserve;
