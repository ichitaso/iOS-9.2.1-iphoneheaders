...
@class AVPlayerLayer, CALayer, ISCrossfadeLayer, ISPlayer, NSHashTable, NSObject, AVPlayer, NSError, ISPlaybackSpec, UIScrollView, ISVitalityFilter, UIView, _ISTargetView, _ISAVPlayerView, _ISCrossfadeView, _ISPlayerDebugView, ISGestureInput, ISVitalityInput, ISMutedAudioInput, NSMutableSet, UIGestureRecognizer, NSString;
