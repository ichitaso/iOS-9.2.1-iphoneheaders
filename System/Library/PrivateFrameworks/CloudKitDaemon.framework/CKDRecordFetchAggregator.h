...
@property (nonatomic,retain) NSMutableDictionary * fetchErrorsByRecordID;                  //@synthesize fetchErrorsByRecordID=_fetchErrorsByRecordID - In the implementation block
...
-(NSMutableDictionary *)fetchErrorsByRecordID;
-(void)setFetchErrorsByRecordID:(NSMutableDictionary *)arg1 ;
