...
@class SUAutoInstallOperation, RemoteUIController, NSString, NSDateComponentsFormatter, SUManagerClient, UIViewController, SUDescriptor, SUDownload, SUMutableDownloadMetadata, RUIStyle;

@interface PSUISoftwareUpdateManager : NSObject <SUManagerClientDelegate, RemoteUIControllerDelegate, SUNetworkObserver> {
