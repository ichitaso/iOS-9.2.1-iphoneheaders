...
@property (nonatomic,readonly) BOOL shouldDoSecondNormalPullPhase;                   //@synthesize shouldDoSecondNormalPullPhase=_shouldDoSecondNormalPullPhase - In the implementation block
