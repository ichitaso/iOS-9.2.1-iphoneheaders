...
@class NSObject, MRDNowPlayingDataSource, MRDNowPlayingInfoServer, MRDAirPlayServer, MRDRemoteControlServer, MRDBrowsableContentServer, MRDMediaRemoteClient, NSMutableDictionary, NSMutableArray, NSMutableSet, MRMutableApplicationActivity, NSLock, NSArray, NSString;
