...
-(void)_queue_cleanupContext:(SCD_Struct_BS2*)arg1 withResponse:(id)arg2 ;
-(SCD_Struct_BS3)listenForResponseWithHandler:(/*^block*/id)arg1 timeout:(unsigned long long)arg2 ;
-(void)clearListenerForTokens:(SCD_Struct_BS3*)arg1 ;
-(void)dealloc;
-(id)init;
