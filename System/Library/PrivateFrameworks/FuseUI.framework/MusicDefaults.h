...
@property (assign,nonatomic) long long versionOfNoThanksOptionWhenUserLastSawWelcomeScreen; 
@property (assign,nonatomic) long long versionOfNotNowOptionWhenUserLastSawWelcomeScreen; 
...
-(long long)versionOfNoThanksOptionWhenUserLastSawWelcomeScreen;
-(BOOL)hasSetVersionOfNotNowOption;
-(long long)versionOfNotNowOptionWhenUserLastSawWelcomeScreen;
-(void)setVersionOfNoThanksOptionWhenUserLastSawWelcomeScreen:(long long)arg1 ;
-(void)setVersionOfNotNowOptionWhenUserLastSawWelcomeScreen:(long long)arg1 ;
