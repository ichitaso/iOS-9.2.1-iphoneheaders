...
@property (nonatomic,retain) HMDApplicationVendorIDStore * applicationVendorIDStore;              //@synthesize applicationVendorIDStore=_applicationVendorIDStore - In the implementation block
...
-(void)setApplicationVendorIDStore:(HMDApplicationVendorIDStore *)arg1 ;
