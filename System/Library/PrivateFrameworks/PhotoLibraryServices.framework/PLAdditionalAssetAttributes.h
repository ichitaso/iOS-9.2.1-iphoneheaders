...
+(id)newExtraDurationDataFromStillDisplayTime:(SCD_Struct_PL10)arg1 videoDuration:(SCD_Struct_PL10)arg2 ;
+(void)fromExtraDurationData:(id)arg1 getStillDisplayTime:(SCD_Struct_PL10*)arg2 videoDuration:(SCD_Struct_PL10*)arg3 ;
