...
@property (nonatomic,readonly) SCD_Struct_PL10 photoIrisStillDisplayTime; 
@property (nonatomic,readonly) SCD_Struct_PL10 photoIrisVideoDuration; 
...
-(BOOL)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 videoDuration:(SCD_Struct_PL10)arg3 stillDisplayTime:(SCD_Struct_PL10)arg4 createSidecar:(BOOL)arg5 ;
...
-(NSURL *)mainFileURL;
-(id)imageProperties;
-(SCD_Struct_PL10)photoIrisStillDisplayTime;
-(double)aspectRatio;
-(NSString *)pathForVideoFile;
-(SCD_Struct_PL10)photoIrisVideoDuration;
