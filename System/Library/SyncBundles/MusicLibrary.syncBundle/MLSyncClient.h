...
@class ML3MusicLibrary, NSMutableDictionary, NSArray, NSDate, NSMutableArray, NSNotificationCenter, NSObject, MPStoreDownloadManager, ATEnvironmentMonitor, NSString;
