...
@property (assign,nonatomic) id<SBAlertWindowDelegate> alertWindowDelegate;              //@synthesize alertWindowDelegate=_alertWindowDelegate - In the implementation block
