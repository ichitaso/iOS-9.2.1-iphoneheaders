...
-(void)_scheduleInstallAlertReminderWithDate:(id)arg1 forReason:(id)arg2 isTransient:(BOOL)arg3 ;
...
-(void)_presentAuthenticationUIForInstallation:(/*^block*/id)arg1 withInstallType:(unsigned long long)arg2 ;
-(void)_scheduleInstallAlertReminderTimerWithDateComponentsFromNow:(id)arg1 forReason:(id)arg2 isTransient:(BOOL)arg3 ;
