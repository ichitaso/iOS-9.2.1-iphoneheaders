...
#import <SpringBoard/SBApplicationShortcutServerDelegate.h>
...
@class NSMutableDictionary, NSMutableSet, NSDictionary, NSLock, NSSet, BKSApplicationStateMonitor, SBApplicationRestrictionController, SBApplicationLibraryObserver, FBApplicationLibrary, FBApplicationInfo, SBReverseCountedSemaphore, NSString;
