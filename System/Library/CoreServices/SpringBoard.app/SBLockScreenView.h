...
@property (nonatomic,retain,readonly) UIScrollView * scrollView;                                                                                          //@synthesize foregroundScrollView=_foregroundScrollView - In the implementation block
...
@property (nonatomic,retain,readonly) UIView * foregroundView;                                                                                            //@synthesize foregroundView=_foregroundView - In the implementation block
