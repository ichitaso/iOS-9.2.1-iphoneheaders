...
@interface SBStatusBarStateProvider : NSObject <SBStatusBarStateAggregatorPosting, UIStatusBarStateProvider> {
	...
	SCD_Struct_SB39 _aggregatorData;
	int _aggregatorActions;
	SCD_Struct_SB39 _lastPost;
...
-(void)statusBarStateAggregator:(id)arg1 didVisitItem:(int)arg2 withUpdates:(BOOL)arg3 toData:(const SCD_Struct_SB39*)arg4 ;
-(void)statusBarStateAggregator:(id)arg1 didUpdateNonItemData:(const SCD_Struct_SB39*)arg2 ;
-(void)statusBarStateAggregatorDidFinishPost:(id)arg1 withData:(const SCD_Struct_SB39*)arg2 actions:(int)arg3 ;
-(BOOL)_shouldPostForVisitedItem:(int)arg1 withUpdates:(BOOL)arg2 toAggregatorData:(const SCD_Struct_SB39*)arg3 ;
-(void)_composePostDataFromAggregatorData:(SCD_Struct_SB39*)arg1 ;
-(void)_composePostActionsFromAggregatorActions:(int*)arg1 ;
-(BOOL)_shouldPostForUpdatesToNonItemData:(const SCD_Struct_SB39*)arg1 ;
-(void)_didChangeDoubleHeightStatusStringForStyle:(long long)arg1 ;
-(void)dealloc;
-(id)init;
-(void)addStatusBarStateObserver:(id)arg1 ;
-(void)getStatusBarData:(SCD_Struct_SB39*)arg1 ;
